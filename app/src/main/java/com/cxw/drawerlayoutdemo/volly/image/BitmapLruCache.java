package com.cxw.drawerlayoutdemo.volly.image;
...
import com.cxw.drawerlayoutdemo.volly.bean.Constants;
import com.cxw.drawerlayoutdemo.volly.util.EncryptionUtil;
import com.cxw.drawerlayoutdemo.volly.util.ImageUtil;
...
public class BitmapLruCache extends LruCache<String, Bitmap> implements ImageCache {
	...
	protected void entryRemoved(boolean evicted, String key, Bitmap oldValue,Bitmap newValue) {
		if (evicted) {
			if(Constants.DEBUG){
				Log.i(TAG, "BitmapLruCache 空间已满，缓存图片被挤出:" + key);
			}
